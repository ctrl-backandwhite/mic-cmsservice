...
public class LoyaltyController {
    ...
    public ResponseEntity<LoyaltyTierDtoOut> findTierById(@RequestHeader(AppConstants.HEADER_NX036_AUTH) String nxAuth,
    ...
    public ResponseEntity<LoyaltyTierDtoOut> createTier(@RequestHeader(AppConstants.HEADER_NX036_AUTH) String nxAuth,
    ...
    public ResponseEntity<LoyaltyTierDtoOut> updateTier(@RequestHeader(AppConstants.HEADER_NX036_AUTH) String nxAuth,
            @PathVariable String id, @Valid @RequestBody LoyaltyTierDtoIn dto) {
    ...
    public ResponseEntity<Void> deleteTier(@RequestHeader(AppConstants.HEADER_NX036_AUTH) String nxAuth,
            @PathVariable String id) {
    ...
    public ResponseEntity<LoyaltyRuleDtoOut> findRuleById(@RequestHeader(AppConstants.HEADER_NX036_AUTH) String nxAuth,
            @PathVariable String id) {
    ...
    public ResponseEntity<LoyaltyRuleDtoOut> createRule(@RequestHeader(AppConstants.HEADER_NX036_AUTH) String nxAuth,
    ...
    public ResponseEntity<LoyaltyRuleDtoOut> updateRule(@RequestHeader(AppConstants.HEADER_NX036_AUTH) String nxAuth,
            @PathVariable String id, @Valid @RequestBody LoyaltyRuleDtoIn dto) {
    ...
    public ResponseEntity<LoyaltyBalanceDtoOut> getBalance(@RequestHeader(AppConstants.HEADER_NX036_AUTH) String nxAuth,
    ...
    public ResponseEntity<LoyaltyTransactionDtoOut> earnPoints(
            @RequestHeader(AppConstants.HEADER_NX036_AUTH) String nxAuth,
            @RequestHeader(value = "X-Auth-Subject") String userId, @Valid @RequestBody LoyaltyEarnDtoIn dto) {
    ...
    public ResponseEntity<java.util.Map<String, Object>> getRedemptionRate(
        ...
        int pointsPerDollar = rules.stream()
                .filter(r -> r.getAction() == com.backandwhite.domain.valueobject.LoyaltyAction.REDEMPTION
                        && r.isActive())
                .findFirst().map(com.backandwhite.domain.model.LoyaltyRule::getPointsPerUnit).orElse(100);
    ...
    public ResponseEntity<PaginationDtoOut<LoyaltyTransactionDtoOut>> getHistory(
            @RequestHeader(AppConstants.HEADER_NX036_AUTH) String nxAuth,
            @RequestHeader(value = "X-Auth-Subject") String userId, @RequestParam(defaultValue = "0") int page,
