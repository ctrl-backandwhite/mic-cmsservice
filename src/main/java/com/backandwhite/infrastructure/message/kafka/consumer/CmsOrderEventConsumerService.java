...
/**
 * Consumes order delivery events and delegates loyalty processing
 * to the LoyaltyMachine.
 *
 * Points are awarded using formula:
...
public class CmsOrderEventConsumerService {
    ...
    public void onOrderDelivered(OrderDeliveredEvent event) {
        ...
        try {
            ...
            log.info("::> Loyalty processed: user={}, earned={}, bonus={}, tier={}, levelUp={}",
